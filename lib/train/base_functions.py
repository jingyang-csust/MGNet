...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        ...
        if name == "LasHeR_all":
            datasets.append(LasHeR(settings.env.lasher_dir, split='all', image_loader=image_loader))
        ...
        if name == "LasHeR_val":
            datasets.append(LasHeR(settings.env.lasher_dir, split='val', image_loader=image_loader))
        if name == "VisEvent":
