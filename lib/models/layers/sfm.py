...
from lib.models.layers.channel_attn import Attention_Module
from lib.models.layers.lpu import LPU
...
class SFM(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        # print("----------",x1.shape) # ([2, 256, 768])
        x1, x2 = self.cross(x1, x2)
        merge = x1 + x2
        # print("mmmm",merge.shape)   ([2, 256, 768])
