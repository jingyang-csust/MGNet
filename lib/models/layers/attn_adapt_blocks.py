...
from lib.models.layers.adapter_upgtaded3 import Bi_direct_adapter
from lib.models.layers.attn import Attention
# from lib.models.layers.fusion import rgbt_layer
...
class CEABlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, stages, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
        ...
        self.adap_fusion = Bi_direct_adapter()
