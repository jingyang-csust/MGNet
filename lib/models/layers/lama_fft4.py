...
class SpectralTransform(nn.Module):
    ...
    def __init__(self, in_channels=768, out_channels=768, stride=1, groups=1, enable_lfu=True, **fu_kwargs):
        # bn_layer not used
        self.hidden_dim = 8
        super(SpectralTransform, self).__init__()
        self.down = nn.Linear(in_channels,self.hidden_dim)
        self.up = nn.Linear(self.hidden_dim,in_channels)
    ...
    def forward(self, x):
        ...
        output = torch.cat((output_z,output),dim=1)
