...
class VisionTransformerCE(VisionTransformer):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        H, W = search_size
        new_search_P_H, new_search_P_W = H // new_patch_size, W // new_patch_size
        self.num_patches_search=new_search_P_H * new_search_P_W
        H, W = template_size
        new_template_P_H, new_template_P_W = H // new_patch_size, W // new_patch_size
        self.num_patches_template=new_template_P_H * new_template_P_W
        ...
        for i in range(depth):
            ...
            if i < 20:
                ...
                CEABlock(
                        ...
                        channel=self.num_patches_template+self.num_patches_search,control_fft=control_fft)
                )
            else:
                blocks.append(
                    DSBlock(
...
###################################################################===========
        ...
        for i, blk in enumerate(self.blocks):
            ...
            xi, global_index_ti, global_index_si, removed_index_si, attn_i = \
                blk(x, xi, lens_z, global_index_t, global_index_ti, global_index_s, global_index_si, mask_x, ce_template_mask,
                    ce_keep_rate)
